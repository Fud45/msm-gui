Rails.application.routes.draw do
  ...
  post("/update_director_record/:an_id", { :controller => "directors", :action => "update" })
  ...
  post("/update_movie_record/:an_id", { :controller => "movies", :action => "update" })
  ...
  post("/update_actor_record/:an_id", { :controller => "actors", :action => "update" })
end
